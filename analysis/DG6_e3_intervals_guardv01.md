<!--
  generated 2026-08-14 18:49:54 +0800 by e3_intervals.py (l1-dg6-intervals-1)
  ...
  /home/ziheng/PaperL1/results/e3_replay_qwen14b/verdicts.jsonl sha256 68d598fcab8bb6aff9bd83e73f4548df1bc7bef426a07bd1f048de59ffc2f37f
  /home/ziheng/PaperL1/results/e3_replay_qwen27b/verdicts.jsonl sha256 73aa56d7e1e552278b0561b3fa26a7b10e0407a9e9ec6e0de3ea880e0517ad77
  /home/ziheng/PaperL1/results/e3_replay_openai/verdicts.jsonl sha256 2009fa24a47dc0efe3afc2ed38edd039eb0b8b43b675337ae5acd718e0139028
  /home/ziheng/PaperL1/results/e3_replay_deepseek/verdicts.jsonl sha256 dcab33a1e04f1d7116ae5cf7c751aeaf5d5a5523ca023042926057b56b2fc61f
  /home/ziheng/PaperL1/results/e3_replay_sonnet/verdicts.jsonl sha256 8d7487aa2976b619ee9a019f2259b84b03d8937f48b559d0aee21d761ed4ee96
  /home/ziheng/PaperL1/results/e3_replay_opus/verdicts.jsonl sha256 f0d25bb6a6c3ea1c797525473724344e06f04fdb59c5fbbb738aa95c4627eb19
  /home/ziheng/PaperL1/analysis/E8_adjudication.csv sha256 be62fba9aa805e786cf6048ab5d15e937ef22b9b2087d7f810d75a1fe65554e0
...
All 271 assertions passed (0 failed). What was reproduced:
...
| --- | --- |
| violation pass-through, five arms with executable unguarded proposals | 17.7 to 25.0 pp |
| mean per-item end-task quality, same five arms | 36.8 to 44.3 bh |

- **Binary outcomes: 5 pp primary.** Five percentage points is 28% of the smallest guard effect on violation pass-through (17.7 pp), so declaring the two architectures equivalent at this margin still preserves 72% of the effect the guard itself buys. The conventional half-of-the-reference-effect rule would license 8.9 pp, so 5 pp is the stricter choice. In workload terms it is 4.8 instructions out of the 96 labelled violations, or roughly one violating instruction per twenty.
- **2.5 pp and 10 pp** are reported beside it. 10 pp is the loosest defensible margin: it is 56% of the smallest guard effect, at the edge of the conventional rule.
...
At the loose budget the observed discordance is far below that. Of the 18 binary cells, 5 had enough discordant pairs for an uncorrected significant result to be arithmetically possible, and 2 had enough for a Holm-corrected one. On end-task quality the same arithmetic applies to the number of items whose schedules differ at all, because the signed-rank test with every difference in one direction gives the same p-value as McNemar with every discordant pair in one direction: 4 of the 6 arms had enough differing items for an uncorrected significant result and 1 for a Holm-corrected one.

**Taking the 24 loose-budget cells together, 3 of 24 could have returned a Holm-significant result at any true effect size, and 9 of 24 could have returned an uncorrected one.** The loose-budget null is therefore in large part a statement about the instrument, not about the architectures.

Holding each cell's discordance rate at its observed value, 80% power is out of reach at any risk difference in 14 of the 18 loose binary cells even with no correction at all. The 4 cells where an uncorrected test could have reached 80% power needed a true difference of 8.7 to 12.2 pp. Under the Holm correction only one cell reached it: deepseek / passthrough, 17 discordant pairs, 16.7 pp.
...
| qwen14b | passthrough | 96 | 1 / 5 | -4.17 pp | [-9.38, +0.00] | [-8.99, +0.72] | [-8.33, +0.00] | SINGLE+G | indet | indet | equiv |
...
| qwen27b | passthrough | 96 | 3 / 1 | +2.08 pp | [-2.08, +6.25] | [-1.92, +6.05] | [-1.04, +5.21] | MULTI-G | indet | indet | equiv |
...
| openai | passthrough | 96 | 6 / 3 | +3.12 pp | [-3.12, +9.38] | [-2.89, +9.08] | [-2.08, +8.33] | MULTI-G | indet | indet | equiv |
...
| deepseek | passthrough | 96 | 5 / 12 | -7.29 pp | [-15.62, +1.04] | [-15.59, +1.03] | [-14.58, +0.00] | SINGLE+G | indet | indet | indet |
...
| sonnet | passthrough | 96 | 5 / 5 | +0.00 pp | [-6.25, +6.25] | [-6.34, +6.34] | [-5.21, +5.21] | neither | indet | indet | equiv |
...
| opus | passthrough | 96 | 2 / 2 | +0.00 pp | [-4.17, +4.17] | [-4.01, +4.01] | [-3.12, +3.12] | neither | indet | equiv | equiv |
...
| arm | outcome | n | a-only / b-only | RD | 95% CI (bootstrap) | 95% CI (Newcombe) | 90% CI (bootstrap) | favours | 2.5 pp | 5 pp | 10 pp |
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- | --- | --- | --- |
| qwen14b | false_block | 96 | 5 / 0 | +5.21 pp | [+1.04, +10.42] | [+0.35, +11.62] | [+2.08, +9.38] | MULTI-G | indet | indet | indet |
| qwen14b | catch | 96 | 30 / 0 | +31.25 pp | [+21.88, +40.62] | [+22.01, +41.09] | [+23.96, +39.58] | SINGLE+G | REFUTED | REFUTED | REFUTED |
| qwen14b | passthrough | 96 | 18 / 0 | +18.75 pp | [+11.46, +27.08] | [+11.16, +27.70] | [+12.50, +25.00] | MULTI-G | REFUTED | REFUTED | REFUTED |
...
| qwen27b | passthrough | 96 | 20 / 0 | +20.83 pp | [+12.50, +29.17] | [+12.91, +30.00] | [+14.58, +28.12] | MULTI-G | REFUTED | REFUTED | REFUTED |
| openai | false_block | 96 | 6 / 0 | +6.25 pp | [+2.08, +11.46] | [+1.15, +12.97] | [+2.08, +10.42] | MULTI-G | indet | indet | indet |
| openai | catch | 96 | 36 / 2 | +35.42 pp | [+25.00, +45.83] | [+24.63, +45.49] | [+27.08, +44.79] | SINGLE+G | REFUTED | REFUTED | REFUTED |
| openai | passthrough | 96 | 35 / 0 | +36.46 pp | [+27.08, +45.83] | [+26.83, +46.29] | [+28.12, +44.79] | MULTI-G | REFUTED | REFUTED | REFUTED |
...
| deepseek | passthrough | 96 | 4 / 0 | +4.17 pp | [+1.04, +8.33] | [-0.44, +10.23] | [+1.04, +7.29] | MULTI-G | indet | indet | equiv |
| sonnet | false_block | 96 | 1 / 4 | -3.12 pp | [-8.33, +1.04] | [-9.26, +2.05] | [-7.29, +0.00] | SINGLE+G | indet | indet | equiv |
| sonnet | catch | 96 | 22 / 1 | +21.88 pp | [+13.54, +30.21] | [+13.18, +31.02] | [+14.58, +29.17] | SINGLE+G | REFUTED | REFUTED | REFUTED |
| sonnet | passthrough | 96 | 16 / 4 | +12.50 pp | [+4.17, +21.87] | [+3.64, +21.61] | [+5.21, +19.79] | MULTI-G | REFUTED | REFUTED | indet |
| opus | false_block | 96 | 3 / 0 | +3.12 pp | [+0.00, +7.29] | [-0.91, +8.81] | [+1.04, +6.25] | MULTI-G | indet | indet | equiv |
| opus | catch | 96 | 26 / 0 | +27.08 pp | [+18.75, +36.46] | [+18.38, +36.46] | [+19.79, +34.38] | SINGLE+G | REFUTED | REFUTED | REFUTED |
| opus | passthrough | 96 | 26 / 2 | +25.00 pp | [+15.62, +34.38] | [+15.33, +34.75] | [+16.67, +33.33] | MULTI-G | REFUTED | REFUTED | REFUTED |
...
The 240 items are drawn from 55 scheduling instances, up to 12 items per instance, so the paired differences are not independent across items. A cluster bootstrap that resamples whole instances is reported beside the item bootstrap. The largest absolute difference between a cluster-bootstrap endpoint and the corresponding item-bootstrap endpoint, over the 18 loose-budget binary cells, is 1.04 pp; over all 36 binary cells it is 1.96 pp. Clustering therefore does not change any verdict: the contrast is taken within an item, so the instance-level component of the variance cancels before the paired difference is formed.

## The honest answer

**One sentence.** At the loose budget the two architectures are equivalent within 10 percentage points on 16 of the 18 binary arm-by-outcome cells and within 5 points on 8, and equivalent within 10 weighted business hours on end-task quality on all 6 arms, but the design never had the power to say more than that: no paired difference exceeds 7.3 pp, yet the intervals still admit differences of up to 15.6 pp, so the null is a statement of no *detectable* difference, not of no difference.
...
- **5.0 pp**: 8 established, 10 indeterminate, 0 refuted.
...
| --- | ---: | ---: | ---: |
| 90% bootstrap | 4/18 | 8/18 | 16/18 |
| 95% bootstrap | 4/18 | 8/18 | 16/18 |
| 90% Newcombe | 0/18 | 8/18 | 16/18 |
| 95% Newcombe | 0/18 | 5/18 | 15/18 |
| 90% cluster bootstrap | 4/18 | 12/18 | 16/18 |

No cell is *refuted* at any margin at the loose budget: the sample is never large enough to affirm a difference as big as 2.5 pp. At the tight budget, by contrast, 11 of 18 cells are refuted at 5 pp, which is the availability effect the manuscript already reports.
...
- **deepseek / passthrough** (lower is better): risk difference -7.3 pp, 90% bootstrap CI [-14.6, +0.0] pp, 90% Newcombe CI [-14.3, -0.3] pp, 90% cluster CI [-14.7, +0.0] pp. MULTI-G has the higher rate on this outcome, and because lower is better on this outcome the difference favours **SINGLE+G**.
